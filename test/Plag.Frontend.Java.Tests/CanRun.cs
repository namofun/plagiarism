...
namespace Xylab.PlagiarismDetect.Frontend.Java.Tests
{
    [TestClass]
    public class CanRun
    {
        [DataRow(@"// Source: https://en.wikipedia.org/wiki/Java_syntax
...
class Foo {
    ...
    public Foo(int a, int b) {
        this();
        System.out.println(Foo.class.getName() + "": overloaded constructor "");
    }
    int bar(int a, int b) {
        return (a*2) + b;
    }
